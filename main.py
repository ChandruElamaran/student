...
class Student:
    def __init__(self,main):
        ...
        self.T_Frame.pack()
        self.Title=Label(self.T_Frame,text="Student management System",font="arial 20 bold",width=1200,bg="yellow",relief=GROOVE)
        self.Title.pack()
...
# =================== Butttons =============================
    ...
    def Update(self):
        ...
        if not selected_items:
            print("Please select a student to update.")  # You can replace this with a label or status message in your GUI
            return
